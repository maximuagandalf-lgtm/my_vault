...
app.use(cors({
    origin: `${process.env.CORS_ORIGIN || '*'}` //allows HTTP requests only from this port
}))

// connecting to MongoDB
mongoose.connect(`${process.env.MONGODB_URI}`).then(()=> console.log('Connected to MongoDB')).catch((err)=> console.log('MongoDB connection error: ', err));
